...
console.log(sys.get.PowerScheme())
console.log(sys.do.findProcessByWindowTitle('Task Manager'))
console.log(sys.do.findProcessByWindowTitle('XD'))
//sys.do.killProcessByName('Notepad.exe')
//sys.do.restartSystem()
//sys.do.logoutSystem()
