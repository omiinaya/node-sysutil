...
var get = {
    ...
    /*
    Test: function () {
        var x = `powershell -command "(Get-CimInstance Win32_PhysicalMemory | Measure-Object -Property capacity -Sum).sum /1gb"`
        //var x = `powershell -command "Get-CimInstance -Query 'Select * from Win32_PhysicalMemory'"`
        //var x = `powershell -command "Get-CimInstance -Query 'Select * from Win32_PhysicalMemoryArray'"`
        var y = execSync(x).toString().trim()
        return y
    }
    */
}
