...
var set = {
    ...
    CoreParking: function () {
        const key = 'HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\Control\\Power\\PowerSettings\\54533251-82be-4824-96c1-47b60b740d00\\0cc5b647-c1df-4637-891a-dec35c318583'
    ...
    SageSet: async function () {
        const key = 'HKLM\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Explorer\\VolumeCaches'
        const keys = await core.regQueryKeys(key) 
        console.log(keys)
        //foreach key add value StateFlags0001 type dword data 2
    }
}
