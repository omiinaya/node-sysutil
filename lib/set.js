...
var set = {
    ...
    LocationData: function (a) {
        ...
        switch (a) {
            case 'Allow':
                core.regPut(location, value, a, valueType)
                break;
            case 'Deny':
                core.regPut(location, value, a, valueType)
                break;
            default:
                console.log('Please specify "Allow" or "Deny"');
                break;
        }
    },

    Webcam: function (a) {
        var location = 'HKCU\\Software\\Microsoft\\Windows\\CurrentVersion\\DeviceAccess\\Global\\{E5323777-F976-4f5b-9B55-B94699C46E44}'
        var value = 'Value'
        var valueType = 'REG_SZ'
        switch (a) {
            case 'Allow':
    ...
    Administrator: function (a) {
        switch (a) {
            ...
            case 'no':
                ...
                break;
            default:
                console.log('Please specify "yes" or "no"')
                break;
        }
    },
