...
var set = {
    ...
    //set visuals to performance, not custom.
    ...
    CloseLidDoNothing: async function () {
        const command1 = 'powercfg -setacvalueindex SCHEME_CURRENT 4f971e89-eebd-4455-a8de-9e59040e7347 5ca83367-6e45-459f-a27b-476b1d01c936 0';
        const command2 = 'powercfg -setdcvalueindex SCHEME_CURRENT 4f971e89-eebd-4455-a8de-9e59040e7347 5ca83367-6e45-459f-a27b-476b1d01c936 0';
        const command3 = `${command1} & ${command2}`
        return core.elevate(command3)
    }
}
